...
<h3 align="center">pharmacy-prices-prediction</h3>

  <p align="center">
    Description for Pharmacy prices prediction
    <br />
    <a href="https://github.com/jpcadena/pharmacy-prices-prediction"><strong>Explore the docs »</strong></a>
    <br />
  </p>
</div>
...
1. Clone the **repository**
    ```
    git clone https://github.com/jpcadena/pharmacy-prices-prediction.git
    ```
2. Change the directory to **root project**
    ```
    cd pharmacy-prices-prediction
    ```
...
E-mail: [Juan Pablo Cadena Aguilar](mailto:jpcadena@espol.edu.ec?subject=[GitHub]pharmacy-prices-prediction)
